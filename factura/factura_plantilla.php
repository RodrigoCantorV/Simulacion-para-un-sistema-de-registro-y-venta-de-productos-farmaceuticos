	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTAS UDEC</span>
					<p>Fusagasuga,Cundinamarca</p>
					<p>Teléfono: +(57) 222-333</p>
					<p>Email: Ucundinamarca.edu.com</p>
				</div>
			</td>
			<td class="info_factura">
				<div class="round">
					...
					<p>Hora: 10:30am</p>
					<p>Vendedor: RODRIGO CANTOR VASQUEZ</p>
				</div>
			</td>
		</tr>
	</table>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						...
						<tr>
							<td><label>Nombre:</label> <p>FRANCY LU</p></td>
							<td><label>Dirección:</label> <p>CUNDINAMARACA-FUSAGASUGA</p></td>
						</tr>
					</table>
				</div>
			</td>
