...
<link rel="stylesheet" type="text/css" href="../CSS/3-interfaz-lista-de-usuarios2.css">
</head>
<body>
...
<a href="2-interfaz-registro-de-usuarios.php"class="btn_new">CREAR USUARIO</a>
  ...
  <hr>
   ...
   <table >
      ...
      $query= mysqli_query($conection, "SELECT u.idusuario, u.nombre,u.apellido,u.documento,u.num_doc,u.cumpleaños,u.genero,u.telefono,u.correo,u.usuario ,r.rol FROM usuario u INNER JOIN rol r ON u.rol =r.idrol WHERE estado=1 ORDER BY idusuario ASC LIMIT $desde,$por_pagina");
