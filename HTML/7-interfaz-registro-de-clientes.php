		...
		$usuario_id = $_SESSION['idUser'];
		 ...
		 (
		 	...
		 	'$usuario_id'
	  	 		...
	  	 		if ($query_insert)
			 {
			$alert='<p class ="msg_save">El usuario fue Guardado con exito</p>';
			}
			else
			{
...
<!DOCTYPE html>
	<html>
		<head>
			...
			<link rel="stylesheet" type="text/css" href="../CSS/7-interfaz-registro-de-clientes.css">
...
<table>
	...
	<label for="nit">N° Documento</label>
		<input type="number" name="nit" id="nit" placeholder="Numero de documento"></td>
	</tr>
	...
	<input type="submit" value="Guardar cliente" class="btn1">
	</div>
</form>
</section>
