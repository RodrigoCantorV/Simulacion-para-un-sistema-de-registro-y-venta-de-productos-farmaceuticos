...
<link rel="stylesheet" type="text/css" href="../CSS/a13-interfaz-busqueda-de-proveedores.css">
</head>
<body>
...
<a href="a13-interfaz-lista-de-proveedores.php">BUSCAR</a>
 ...
 <!--/////////////////////////////////////////////////////////////AQUI TERMINA NUESTRO 2 MENU LATERAL///////////////////////////////////////-->
        ...
        <section class="container">
          ...
          if (empty($busqueda))
           {
            header("location:a13-interfaz-lista-de-proveedores.php");
        ...
        <a href="7-interfaz-registro-de-clientes.php"class="btn_new">GUARDAR PROVEEDOR</a>
             

              <form action="a13-interfaz-lista-de-proveedores.php"method="get"class="form_search">
           ...
           <table >
              ...
              $query= mysqli_query($conection, "SELECT * FROM proveedor 
               ...
               <tr>
                ...
                <td>
                <a class="link_edit" href="a14-interfaz-modificar-proveedores.php?id=<?php echo $data["codproveedor"] ?>">EDITAR</a>
                |
                  <?php
                     if ($_SESSION['rol']==1 || $_SESSION['rol']==2 )
                    {
