...
<link rel="stylesheet" type="text/css" href="../CSS/4-interfaz-modificar-usuario-2.css">
</head>
<body>
...
-->
 ...
 //paginador
      ...
      $query= mysqli_query($conection, "SELECT usuario.idusuario,usuario.nombre,usuario.apellido,usuario.documento,usuario.num_doc,usuario.cumpleaños,usuario.genero,usuario.telefono,usuario.correo,usuario.usuario ,rol.rol FROM usuario,rol WHERE usuario.rol = rol.idrol and estado =1 ORDER BY usuario.idusuario ASC LIMIT $desde,$por_pagina");
