...
include"../HTML/abrir-conexion.php";
 ...
 if (isset($_REQUEST['busqueda']) && $_REQUEST['busqueda']=='')
  {
  header("location: a23-interfaz-lista-de-ventas.php");
 }
...
<link rel="stylesheet" type="text/css" href="../CSS/a24-interfaz-busqueda-de-ventas.css">
</head>
<body>
  ...
  <div>
   ...
   <table >
      ...
      //PAGINADOR
         ...
         $sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM factura WHERE
          $where AND estado != 10");
